...
public class MapMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()){
                    ...
                    case R.id.navigation_home:
                        Intent intent = new Intent(MapMenu.this , Home2Activity.class);
                        startActivity(intent);
                        break;

                    case R.id.navigation_profile:
                        Intent intent2 = new Intent(MapMenu.this , Profile_Activity.class);
        ...
        excitingPlaces = (Button) findViewById(R.id.excitingPlacesBtn);
        seeMap = (Button) findViewById(R.id.seeMapBtn);
